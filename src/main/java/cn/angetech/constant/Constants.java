...
public class Constants {
    ...
    public static final String FIELD_CLICK_PRODUCTIDS="clickProductIds";
    public static final String FIELD_ORDER_CATEGORYIDS="orderCategoryIds";
    public static final String FIELD_ORDER_PRODUCTIDS="orderProductIds";
    public static final String FIELD_PAY_CATEGORYIDS="payCategoryIds";
    public static final String FIELD_PAY_PRODUCTIDS="payProductIds";
    ...
    * */
    ...
    public static final String PARAM_ENDTDATE ="endDate";
    ...
    public static final String TIME_PERIOD_0s = "0s";
