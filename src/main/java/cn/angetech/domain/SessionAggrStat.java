...
public class SessionAggrStat implements Serializable {
    ...
    private double visit_Length_0s;
    ...
    public void set(Long taskId, Long sessionCount,double visit_Length_0s, double visit_Length_1s_3s, double visit_Length_4s_6s, double visit_Length_7s_9s, double visit_Length_10s_30s, double visit_Length_30s_60s, double visit_Length_1m_3m, double visit_Length_3m_10m, double visit_Length_10m_30m, double visit_Length_30m, double step_Length_1_3, double step_Length_4_6, double step_Length_7_9, double step_Length_10_30, double step_Length_30_60, double step_Length_60) {
        this.taskId = taskId;
        SessionCount = sessionCount;
        this.visit_Length_0s = visit_Length_0s;
    ...
    public double getVisit_Length_0s() {
        return visit_Length_0s;
    }

    public void setVisit_Length_0s(double visit_Length_0s) {
        this.visit_Length_0s = visit_Length_0s;
    }
